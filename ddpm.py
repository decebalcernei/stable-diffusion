...
class DDPMSampler:
    ...
    def __init__(self, generator: torch.Generator, num_training_steps=1000, beta_start=0.00085, beta_end=0.012):
        ...
        self.alpha_cumprod = torch.cumprod(self.alphas, 0) # comulative products [alpha0, alpha0*alpha1, alpha0*alpha1*alpha2,...]
    ...
    def set_inference_timesteps(self, num_inference_steps=50):
        ...
        # 999, 998, 997, 996, ..., 0 -> 50 steps -> 999, 979, 959, 939, ..., 0
    ...
    def add_noise(self, original_samples, timestep):
        # at which time step to add the noise.
        # we need the mean and the variance.
        ...
        sqrt_one_minus_alpha_prod = (1 - alpha_cumprod[timestep]) ** 0.5 # std dev
    ...
    def step(self, timestep, latents, model_output):
        ...
        # Compute the coeff. for pred_original_sample and current sample x_t
